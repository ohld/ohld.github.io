...
Опытные AI-разработчики уже поняли: всю инфу всех проектов не уместить в одном контексте. А так хочется иметь `single point of contact`: писать Chief of Staff, чтобы он догрузил нужную инфу и порешал сам, делегируя работу субагентам.
...
Один Chief видит все проекты и держит общий борд. Остальные боты работают по своим функциям.
