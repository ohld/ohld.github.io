import{a as d,u as l,j as e,F as p}from"./index-B-4F7cGB.js";import{B as s}from"./BackButton-TQ0x2sQE.js";import{b as m,h as n}from"./structuredData-DhIUrdZ2.js";const r=`
<div class="mvh-meta">
...
`;function x(){const t=d("/articles/markdown-vs-html/"),o="Почему HTML побеждает markdown как формат вывода для AI-агентов. Плотность инфы, читаемость, шеринг, интерактив. С примерами промптов и реальными кейсами.",a="Markdown мёртв — да здравствует HTML | Даниил Охлопков",i=["AI Agents","HTML","Claude Code"];return l({title:a,description:o,canonical:t,type:"article",publishedTime:"2026-05-09",modifiedTime:"2026-05-10",tags:i,section:"Статьи",jsonLd:m({title:a,description:o,canonical:t,publishedAt:"2026-05-09",updatedAt:"2026-05-10",tags:i,section:"Статьи",bodyText:n(r)})}),e.jsxs("div",{className:"page",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:h}}),e.jsxs("div",{className:"subpage-header",children:[e.jsx(s,{}),e.jsx("h1",{className:"subpage-title",children:"Markdown мёртв — да здравствует HTML"}),e.jsx("p",{className:"subpage-subtitle",children:"Из курса · перевод поста Tariq из команды Claude Code, с моими примерами"})]}),e.jsx("article",{id:"article-content",className:"mvh-page",dangerouslySetInnerHTML:{__html:r}}),e.jsx(p,{})]})}export{x as MarkdownVsHtml};
