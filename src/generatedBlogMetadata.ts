...
const generatedArticlePostMeta: GeneratedPostMeta[] = [
  ...
  {
    slug: 'telegram-bot-trends-august-2026',
    title: 'Telegram Bot and Mini App Trends: August 2026',
    description: 'Original August 2026 data on Telegram bot trends: gift casinos grew 104%, Stars resellers fell 39%, and 104 doorway bots reached 20.3M combined MAU.',
    seoTitle: 'Telegram Bot Trends 2026: Casinos, Stars, Doorway Bots',
    seoDescription: 'Original August 2026 data on Telegram bot trends: gift casinos grew 104%, Stars resellers fell 39%, and 104 doorway bots reached 20.3M combined MAU.',
    publishedAt: '2026-09-02',
    updatedAt: '2026-09-02',
    lang: 'en',
    readingTime: '9 min',
    tags: ['Telegram', 'Telegram Bots', 'Mini Apps', 'Data Analytics', 'Marketing'],
    coverImage: '/assets/articles/telegram-bots-mini-apps-trends-august-2026/telegram-gift-casinos-growth-en.webp',
    coverAlt: 'Telegram bot trends in August 2026: gift casinos grew 104% while Stars resellers fell 39%',
  },
  {
