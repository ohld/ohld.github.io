...
const IMAGE_DIMENSIONS: Record<string, ImageDimensions> = {
  ...
  '/assets/articles/hermes-agent-vs-openclaw/hermes-openclaw-cover.webp': { width: 1376, height: 768 },
  ...
  '/assets/blog/ai-agents-s-chego-nachat/ai-agents-playlist-meme.webp': { width: 1376, height: 768 },
  ...
  '/assets/blog/claude-code-vs-codex-perehod/telegram-cover.webp': { width: 700, height: 590 },
  '/assets/blog/gstack-goal-office-hours-ai-workflow/telegram-cover.webp': { width: 753, height: 800 },
  '/assets/blog/improve-codebase-architecture-prompt/architecture-prompt-cover.webp': { width: 1376, height: 768 },
  '/assets/blog/my-ai-setup-2026-claude-code-cursor-spokenly-ghostty/phone-agent-meme.webp': { width: 1376, height: 768 },
  '/assets/blog/vibecoding-telegram-mini-app-claude-code/tma-llms-cover.webp': { width: 1376, height: 768 },
}
