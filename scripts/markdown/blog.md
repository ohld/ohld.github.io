...
> Мои записи и рабочие заметки.

Блог — это мои записи про AI-агентов, инструменты, контекст и практику разработки. Если материал вырос из короткого поста, живой текст остаётся максимально близко к оригиналу, а структура, источники и внутренние ссылки помогают читать его как нормальную страницу.
...
- [Compaction в Claude Code: как работает сжатие контекста](/claude-code-compaction-kak-rabotaet/)
- [Claude Code + Codex: двойное ревью AI-агентов](/claude-codex-dual-review/)
- [Форум AI-агентов в Telegram-чате](/ai-agent-forum-telegram-chat-agenty/)

## Как это будет развиваться

Дальше сюда будут попадать новые записи, обогащённые инсайтами из обсуждений, ссылками на связанные статьи, YouTube-видео и полезные источники.
