...
const ROUTES = [
  ...
  },
  {
    ...
    description: 'Разбор стрима про design engineering: как дизайнерам работать с AI-агентами, почему появляется AI-slop, зачем нужны design tokens, Figma MCP, Paper, Mobbin MCP и хороший контекст для Codex/Claude Code.',
